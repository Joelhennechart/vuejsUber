<template>
  ...
  // pour que search n'affiche plus rien quand on a rien a chercher: 2 solutions:
  ...
  <style lang="scss">
      .home{
          ...
          .bannier{
              height: 200px;
              width: 100%;
              background-image: url('../components/icons/WelcomeToUberEats.webp');
