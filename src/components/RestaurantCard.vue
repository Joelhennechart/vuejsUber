...
export default {
    ...
    {const changeBackground = computed(() => {
        return{
            backgroundImage: `url(${props.info_restaurant.image})` //${} signifie qu'on va utiliser du Js dans la chaine de caractére mais qu'a la fin tous est converti en chaine de caractére //
        }
        })
    return{
        changeBackground
